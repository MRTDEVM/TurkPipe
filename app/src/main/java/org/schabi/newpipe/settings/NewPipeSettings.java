...
public final class NewPipeSettings {
    ...
    public static void initSettings(final Context context) {
        ...
        // Force high resolution and WebM format to bypass YouTube 360p limitation
        final SharedPreferences prefs =
                PreferenceManager.getDefaultSharedPreferences(context);
        prefs.edit()
                .putBoolean(context.getString(
                        R.string.show_higher_resolutions_key), true)
                .putString(context.getString(
                        R.string.default_video_format_key),
                        context.getString(R.string.video_webm_key))
                .putString(context.getString(
                        R.string.default_resolution_key), "1080p")
                .apply();
